...
<aside class="c-breakbox c-breakbox--blue">
  <div class="c-breakbox-inner c-breakbox--blue">
    <h3 class="bold"><?php echo __('Mit Code die Welt verbessern', 'lauch'); ?></h3>
    <p class="subline"><?php echo __('Wir sind ein Programm für junge Menschen, die mit ihren technischen Fähigkeiten die Welt verbessern wollen. Folgt uns auf', 'lauch') ?></p>
  </div>
