...
tns(options);});};}
function Toc(selector){this.init=function(obj){this.el=obj;this.nav=this.el.querySelector('.c-toc-nav');if(this.el){this.nav.querySelectorAll('a').forEach(x=>x.addEventListener('click',this.toggleEvent.bind(this)));}
