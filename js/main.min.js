...
function Slider(){this.init=function(sliders){sliders.forEach(item=>{let options={};if(item.dataset.sliderPreset==="auto"){options={container:item,autoWidth:true,controls:false,autoplay:true,autoplayButtonOutput:false,gutter:90,nav:false,autoplayTimeout:3000}}else{options={container:item,slideBy:'page',fixedWidth:350,nav:false,controlsContainer:'.tns-controls',}}
tns(options);});};}
