...
function lauch_exchanges_init() {
    $labels = array(
        'name'                  => _x( 'Exchanges', 'Post type general name', 'textdomain' ),
        'singular_name'         => _x( 'Exchange', 'Post type singular name', 'textdomain' ),
        'menu_name'             => _x( 'Exchanges', 'Admin Menu text', 'textdomain' ),
        'name_admin_bar'        => _x( 'Exchange', 'Add New on Toolbar', 'textdomain' ),
        'add_new'               => __( 'Add New', 'textdomain' ),
        'add_new_item'          => __( 'Add New Exchange', 'textdomain' ),
        'new_item'              => __( 'New Exchange', 'textdomain' ),
        'edit_item'             => __( 'Edit Exchange', 'textdomain' ),
        'view_item'             => __( 'View Exchange', 'textdomain' ),
        'all_items'             => __( 'All Exchanges', 'textdomain' ),
